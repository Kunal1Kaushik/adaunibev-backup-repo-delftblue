...
work_dir = './outputs/finetune_unibev_corruption_2ndrun/unibev_avg_dim_256_nus_LC_full'
load_from = 'remote_checkpoints/focos_3d_r101_centerpoint.pth'
resume_from = 'outputs/finetune_unibev_corruption_2ndrun/unibev_avg_dim_256_nus_LC_full/epoch_13.pth'
plugin = True
...
optimizer = dict(
    ...
    paramwise_cfg=dict(
        custom_keys=dict(
            img_backbone=dict(lr_mult=0.1), pts_backbone=dict(lr_mult=0.1))),
    weight_decay=0.01)
