...
work_dir = './outputs/camera_corruption/unibev_avg_dim_256_nus_LC_full'
load_from = 'remote_checkpoints/focos_3d_r101_centerpoint.pth'
resume_from = 'outputs/camera_corruption/unibev_avg_dim_256_nus_LC_full/epoch_13.pth'
plugin = True
...
train_pipeline = [
    ...
    dict(type='LoadMultiViewImageFromFilesWithRandomZeros', to_float32=True),
    dict(
    ...
    train=dict(
        ...
        pipeline=[
            ...
            dict(
                ...
                with_label_3d=True),
            dict(
                type='LoadMultiViewImageFromFilesWithRandomZeros',
                to_float32=True),
            dict(
