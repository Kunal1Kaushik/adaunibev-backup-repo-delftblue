...
work_dir = './outputs/spatial_unibev_clean/unibev_avg_dim_256_nus_LC_full'
load_from = 'remote_checkpoints/focos_3d_r101_centerpoint.pth'
resume_from = 'outputs/spatial_unibev_clean/unibev_avg_dim_256_nus_LC_full/epoch_9.pth'
plugin = True
