...
#SBATCH --output=outputs/slurm_logs/test_unibev_a40_db_multi_node_%j.out
#SBATCH --error=outputs/slurm_logs/test_unibev_a40_db_multi_node_%j.err
...
source ~/.bashrc
singularity exec --bind /projects:/projects --nv unibev_cuda.sif bash -c '
    ...
    srun python -u tools/train_UniBEV.py ${CONFIG} --launcher="slurm" --work-dir=${WORK_DIR} \
