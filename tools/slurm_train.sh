...
srun singularity exec --nv \
  ...
  bash -c '
    ...
    python -u tools/train_UniBEV.py ${CONFIG} --launcher="slurm" --work-dir=${WORK_DIR} \
        --cfg-options load_from="unibev_avgfusion_moddrop_trained/unibev_avgfusion_moddrop_trained.pth" \
        ${PY_ARGS}
